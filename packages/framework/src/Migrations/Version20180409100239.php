...
class Version20180409100239 extends AbstractMigration
{
    ...
    {
        $this->sql('ALTER TABLE personal_data_access_request ADD type VARCHAR(255)');
        $this->sql('UPDATE personal_data_access_request SET type = :type', ['type' => PersonalDataAccessRequest::PERSONAL_DATA_DISPLAY]);
